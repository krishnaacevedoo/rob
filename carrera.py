...
st.title(":mortar_board: Carrera como Creador de Contenido")
...
st.image("placa.webp", caption="Placas")  # Imagen de sus placas de YouTube
st.image("kickk.webp", caption="Plataforma de stream")  # Imagen de Kick u otra plataforma
