...
st.title(":footprints: Historia de Rob")

# Texto introductorio sobre su origen
st.write(
    "Robleis IUTU, cuyo nombre real es Tomás Arbillaga, nació en Argentina. "
    "Comenzó creando contenido en YouTube con gameplays y rápidamente ganó seguidores."
)
